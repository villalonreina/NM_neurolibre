...
UCLA_0_te = controls_cov.index[controls_cov['site_UCLA_0'] == 1].to_list()
UCLA_1_te = controls_cov.index[controls_cov['site_UCLA_1'] == 1].to_list()
...
controls_cov = controls_cov.drop(['subjectID', 'site_ID_bin', 'site_UCLA_0', 'site_UCLA_1'], axis=1)
