...
NIMHANS_0_te = patients_cov.index[patients_cov['site_NIMHANS_0'] == 1].to_list()
NIMHANS_1_te = patients_cov.index[patients_cov['site_NIMHANS_1'] == 1].to_list()
...
patients_cov = patients_cov.drop(['subjectID', 'site_ID_bin', 'site_NIMHANS_0', 'site_NIMHANS_1'], axis=1)
...
hbr_site_metrics.to_csv(os.path.join(data_dir, 'hbr_NIMHANS_patients_site_metrics_f1.csv'), index=False, index_label=None)

# Save overall test set metrics to CSV file
hbr_metrics.to_csv(os.path.join(data_dir, 'hbr_NIMHANS_patients_metrics_f1.csv'), index=False, index_label=None)
