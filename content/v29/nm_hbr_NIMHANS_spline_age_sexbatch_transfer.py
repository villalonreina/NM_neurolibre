...
controls_cov = controls_cov.drop(['subjectID', args.sex_column, 'site_ID_bin', 'site_NIMHANS_0', 'site_NIMHANS_1'], axis=1)
controls_cov[args.age_column] = controls_cov[args.age_column].astype(float)
