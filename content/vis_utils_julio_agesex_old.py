...
def create_dummy_inputs_sexbatch(processing_dir, site_num, age_range = [10,90], 
    ...
    batch_effects_test_dummy = np.zeros([r*2, 2], dtype=np.int)
    ...
    for i in range(1,site_num):
        ...
        batch_effects_test_dummy = np.concatenate([batch_effects_test_dummy, 
                                                    np.zeros([r*2, 2], dtype=np.int)], axis=0) 
...
def predict_dummy(dir_out, dir_model, site_num, age_min, age_max, roi_id):
    """
...
def plot_normative_models_multi(processing_dir, num_sites, site_id, area_id, metric, age_min, age_max):
   ...
   # This is opening the dummy X_test and the dummy batch files
    ...
    # df_ = pd.read_csv('/Users/julio/Documents/IGC/HBR_paper/Denoising_data/FA_22q_Del_denoised.csv', sep=',', index_col=False)
    # df_ = pd.read_csv('/Users/julio/Documents/IGC/HBR_paper/Denoising_data/PPMI/MD_PPMI_ROItable_Parkinsons_4test.csv')
...
def plot_normative_models_multi_predict(processing_dir, model_dir, num_sites, area_id, metric, age_min, age_max):
    ...
    [yhat_1, s2_1] = predict_dummy(processing_dir + '/Dummy1/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_2, s2_2] = predict_dummy(processing_dir + '/Dummy2/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_3, s2_3] = predict_dummy(processing_dir + '/Dummy3/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_4, s2_4] = predict_dummy(processing_dir + '/Dummy4/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_5, s2_5] = predict_dummy(processing_dir + '/Dummy5/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_6, s2_6] = predict_dummy(processing_dir + '/Dummy6/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_7, s2_7] = predict_dummy(processing_dir + '/Dummy7/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_8, s2_8] = predict_dummy(processing_dir + '/Dummy8/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_9, s2_9] = predict_dummy(processing_dir + '/Dummy9/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_10, s2_10] = predict_dummy(processing_dir + '/Dummy10/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_11, s2_11] = predict_dummy(processing_dir + '/Dummy11/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_12, s2_12] = predict_dummy(processing_dir + '/Dummy12/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_13, s2_13] = predict_dummy(processing_dir + '/Dummy13/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_14, s2_14] = predict_dummy(processing_dir + '/Dummy14/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_15, s2_15] = predict_dummy(processing_dir + '/Dummy15/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_16, s2_16] = predict_dummy(processing_dir + '/Dummy16/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_17, s2_17] = predict_dummy(processing_dir + '/Dummy17/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_18, s2_18] = predict_dummy(processing_dir + '/Dummy18/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_19, s2_19] = predict_dummy(processing_dir + '/Dummy19/', model_dir, num_sites, age_min, age_max, area_id)
    [yhat_20, s2_20] = predict_dummy(processing_dir + '/Dummy20/', model_dir, num_sites, age_min, age_max, area_id)
